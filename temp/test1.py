...
test_atom1=test_crystal.add_atom(DFT_element.Bi, position=np.array([0.0,0.0,0.0]))
test_atom2=test_crystal.add_atom(DFT_element.Bi, position=np.array([1.0,1.0,1.0]))
